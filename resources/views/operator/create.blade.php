    ...
    <div class="max-w-4xl mx-auto py-8">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-10">
                ...
                {{-- Mulai Form --}}
                <form action="{{ route('operator.borrow.store') }}" method="POST" id="main-form" class="space-y-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-12 gap-6 pb-8 border-b border-dashed border-slate-100">
                        ...
                        <div class="col-span-4 space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Estimasi Kembali</label>
                    ...
                    <div id="items-container" class="space-y-6">
                        <div class="flex justify-between items-center mb-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Barang yang Dipinjam</label>
                        ...
                        <div class="item-row bg-slate-50/50 p-6 rounded-[2rem] border border-slate-100 space-y-4">
                            ...
                            <div>
                                <label class="text-[9px] font-bold text-slate-400 uppercase mb-1 block ml-1">Keterangan</label>
